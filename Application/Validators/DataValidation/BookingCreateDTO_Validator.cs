...
{
    public class BookingCreateDTO_Validator : AbstractValidator<BookingCreateDTO>
    {
        public BookingCreateDTO_Validator() {
            ...
            RuleFor(RuleFor => RuleFor.BorrowerId).GreaterThan(0)
